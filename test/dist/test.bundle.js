...
var _indexBundle = __webpack_require__(42);
...
describe('A Redux endpoint module', function () {
  ...
  before(function () {
    ep = (0, _indexBundle.createEndpoint)({
      branch: function branch(id) {
        return id;
      },
  ...
  it('is an object', function () {
    _chai.assert.isObject(ep);
  });

  it('defines actions', function () {
    _chai.assert.isObject(ep.actions);
  });

  it('defines middleware', function () {
    _chai.assert.isFunction(ep.middleware);
  });

  it('defines a reducer', function () {
    _chai.assert.isFunction(ep.reducer);
  });
});
...
(function webpackUniversalModuleDefinition(root, factory) {
	if (( false ? 'undefined' : _typeof(exports)) === 'object' && ( false ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["redux-endpoints"] = factory();else root["redux-endpoints"] = factory();
})(undefined, function () {
	return (/******/function (modules) {
		...
		/***/function (module, exports, __webpack_require__) {
			...
			exports.createEndpoint = undefined;

			__webpack_require__(1);

			var createEndpoint = exports.createEndpoint = function createEndpoint() {};
